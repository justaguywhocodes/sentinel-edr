/*
 * sentinel-agent/output/siem_writer.h
...
#ifndef SENTINEL_SIEM_WRITER_H
#define SENTINEL_SIEM_WRITER_H
...
struct SentinelConfig;  /* Forward declaration */
...
public:
     ...
     */
    void Enqueue(const SENTINEL_EVENT& evt,
